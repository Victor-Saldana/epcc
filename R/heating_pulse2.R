...
# Time
##########################################################
    time_op11=   (b1*(temp_op1-temp_ini[1])-sqrt(b1^2*(temp_op1-temp_ini[1])^2-4*a1*(temp_op1-temp_ini[1])*(temp_op1-temp_ini[1]-q[1])))/(2*(temp_op1-temp_ini[1]-q[1]))+time_start
    time_op12=   (b1*(temp_op1-temp_ini[1])+sqrt(b1^2*(temp_op1-temp_ini[1])^2-4*a1*(temp_op1-temp_ini[1])*(temp_op1-temp_ini[1]-q[1])))/(2*(temp_op1-temp_ini[1]-q[1]))+time_start
  # time_cmin11= (b1*(temp_cmin[1]-temp_ini[1])-sqrt(b1^2*(temp_cmin[1]-temp_ini[1])^2-4*a1*(temp_cmin[1]-temp_ini[1])*(temp_cmin[1]-temp_ini[1]-q[1])))/(2*(temp_cmin[1]-temp_ini[1]-q[1]))+time_start
  # time_cmin12= (b1*(temp_cmin[1]-temp_ini[1])+sqrt(b1^2*(temp_cmin[1]-temp_ini[1])^2-4*a1*(temp_cmin[1]-temp_ini[1])*(temp_cmin[1]-temp_ini[1]-q[1])))/(2*(temp_cmin[1]-temp_ini[1]-q[1]))+time_start
    time_cmax11= (b1*(temp_cmax[1]-temp_ini[1])-sqrt(b1^2*(temp_cmax[1]-temp_ini[1])^2-4*a1*(temp_cmax[1]-temp_ini[1])*(temp_cmax[1]-temp_ini[1]-q[1])))/(2*(temp_cmax[1]-temp_ini[1]-q[1]))+time_start
    time_cmax12= (b1*(temp_cmax[1]-temp_ini[1])+sqrt(b1^2*(temp_cmax[1]-temp_ini[1])^2-4*a1*(temp_cmax[1]-temp_ini[1])*(temp_cmax[1]-temp_ini[1]-q[1])))/(2*(temp_cmax[1]-temp_ini[1]-q[1]))+time_start

  ##########################################################

  time_op21= (b2*(temp_op2-temp_ini[2])-sqrt(b2^2*(temp_op2-temp_ini[2])^2-4*a2*(temp_op2-temp_ini[2])*(temp_op2-temp_ini[2]-q[2])))/(2*(temp_op2-temp_ini[2]-q[2]))+time_start
  time_op22= (b2*(temp_op2-temp_ini[2])+sqrt(b2^2*(temp_op2-temp_ini[2])^2-4*a2*(temp_op2-temp_ini[2])*(temp_op2-temp_ini[2]-q[2])))/(2*(temp_op2-temp_ini[2]-q[2]))+time_start
# time_cmin21= (b2*(temp_cmin[2]-temp_ini[2])-sqrt(b2^2*(temp_cmin[2]-temp_ini[2])^2-4*a2*(temp_cmin[2]-temp_ini[2])*(temp_cmin[2]-temp_ini[2]-q[2])))/(2*(temp_cmin[2]-temp_ini[2]-q[2]))+time_start
# time_cmin22= (b2*(temp_cmin[2]-temp_ini[2])+sqrt(b2^2*(temp_cmin[2]-temp_ini[2])^2-4*a2*(temp_cmin[2]-temp_ini[2])*(temp_cmin[2]-temp_ini[2]-q[2])))/(2*(temp_cmin[2]-temp_ini[2]-q[2]))+time_start
  time_cmax21= (b2*(temp_cmax[2]-temp_ini[2])-sqrt(b2^2*(temp_cmax[2]-temp_ini[2])^2-4*a2*(temp_cmax[2]-temp_ini[2])*(temp_cmax[2]-temp_ini[2]-q[2])))/(2*(temp_cmax[2]-temp_ini[2]-q[2]))+time_start
  time_cmax22= (b2*(temp_cmax[2]-temp_ini[2])+sqrt(b2^2*(temp_cmax[2]-temp_ini[2])^2-4*a2*(temp_cmax[2]-temp_ini[2])*(temp_cmax[2]-temp_ini[2]-q[2])))/(2*(temp_cmax[2]-temp_ini[2]-q[2]))+time_start

  ##########################################################

  time_op31= (b3*(temp_op3-temp_ini[3])-sqrt(b3^2*(temp_op3-temp_ini[3])^2-4*a3*(temp_op3-temp_ini[3])*(temp_op3-temp_ini[3]-q[3])))/(2*(temp_op3-temp_ini[3]-q[3]))+time_start
  time_op32= (b3*(temp_op3-temp_ini[3])+sqrt(b3^2*(temp_op3-temp_ini[3])^2-4*a3*(temp_op3-temp_ini[3])*(temp_op3-temp_ini[3]-q[3])))/(2*(temp_op3-temp_ini[3]-q[3]))+time_start
# time_cmin31= (b3*(temp_cmin[3]-temp_ini[3])-sqrt(b3^2*(temp_cmin[3]-temp_ini[3])^2-4*a3*(temp_cmin[3]-temp_ini[3])*(temp_cmin[3]-temp_ini[3]-q[3])))/(2*(temp_cmin[3]-temp_ini[3]-q[3]))+time_start
# time_cmin32= (b3*(temp_cmin[3]-temp_ini[3])+sqrt(b3^2*(temp_cmin[3]-temp_ini[3])^2-4*a3*(temp_cmin[3]-temp_ini[3])*(temp_cmin[3]-temp_ini[3]-q[3])))/(2*(temp_cmin[3]-temp_ini[3]-q[3]))+time_start
  time_cmax31= (b3*(temp_cmax[3]-temp_ini[3])-sqrt(b3^2*(temp_cmax[3]-temp_ini[3])^2-4*a3*(temp_cmax[3]-temp_ini[3])*(temp_cmax[3]-temp_ini[3]-q[3])))/(2*(temp_cmax[3]-temp_ini[3]-q[3]))+time_start
  time_cmax32= (b3*(temp_cmax[3]-temp_ini[3])+sqrt(b3^2*(temp_cmax[3]-temp_ini[3])^2-4*a3*(temp_cmax[3]-temp_ini[3])*(temp_cmax[3]-temp_ini[3]-q[3])))/(2*(temp_cmax[3]-temp_ini[3]-q[3]))+time_start
  ...
  tM<-c(time_cmax11,time_cmax12,time_cmax21,time_cmax22,time_cmax31,time_cmax32)
  tM_new <- tM

...
##############################################################
    ...
    p2 <- ggplot(data, aes(x=x, y=y)) +
            ...
            geom_vline(xintercept = tm_new2, size=.5, color="green4",linetype="dashed")+
            geom_vline(xintercept = tm_new3, size=.5, color="blue",linetype="dashed")+
            geom_line(data =subset(da1,x>times[1] & x<time_cmin1), color = "brown")+
            geom_line(data =subset(da2,x>times[1] & x<time_cmin2), color = "green4")+
            geom_line(data =subset(da3,x>times[1] & x<time_cmin3), color = "blue")+

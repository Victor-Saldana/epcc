  ...
  #########################################################
    ...
    ##########################################################
      ...
      model1 <- function (times, y,parms1) {
        with(as.list(c(y)), {
          T <- get_RCP8.5(times,a=exp(coef(m)[1]), b=coef(m)[2])+temp_ini[1]
      ...
      model2 <- function (times, y,parms2) {
        with(as.list(c(y)), {
          T <- get_RCP8.5(times,a=exp(coef(m)[1]), b=coef(m)[2])+temp_ini[2]
      ...
      model3 <- function (times, y,parms3) {
        with(as.list(c(y)), {
          T <- get_RCP8.5(times,a=exp(coef(m)[1]), b=coef(m)[2])+temp_ini[3]

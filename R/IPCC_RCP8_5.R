 ...
 ##########################################################
  ...
  #########################################################
    ...
    ##########################################################
      ...
      # utils::globalVariables(c("x", "group", "y"))
      ###############################################################
      # Plots
      ##############################################################
      ...
      # p1 <- ggplot(data, aes(x=times, y=y, group=group, col=group, fill=group)) +
      #         theme_bw()+
      ...
      #
      #
      # p2 <- ggplot(da, aes(x=times, y=y, group=group, col=group, fill=group)) +
      #         theme_bw()+
      #         theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
      #         scale_fill_manual(name='', values=c("Pop1" = "brown", "Pop2" = "green4", "Pop3"="blue"))+
      #         geom_vline(xintercept = time_ext1, size=.5, color="brown",linetype="dashed")+
      #         geom_vline(xintercept = time_ext2, size=.5, color="green4",linetype="dashed")+
      #         geom_vline(xintercept = time_ext3, size=.5, color="blue",linetype="dashed")+
      #         geom_line(data =subset(da1,x>times[1] & x<time_cmax1), color = "brown")+
      #         geom_line(data =subset(da2,x>times[1] & x<time_cmax2), color = "green4")+
      #         geom_line(data =subset(da3,x>times[1] & x<time_cmax3), color = "blue")+

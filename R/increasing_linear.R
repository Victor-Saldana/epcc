...
time_cmin1=(temp_cmin[1]-temp_ini[1])/m[1]+time_start
time_cmax1=(temp_cmax[1]-temp_ini[1])/m[1]+time_start

time_op2=(temp_op2-temp_ini[2])/m[2]+time_start
time_cmin2=(temp_cmin[2]-temp_ini[2])/m[2]+time_start
time_cmax2=(temp_cmax[2]-temp_ini[2])/m[2]+time_start

time_op3=(temp_op3-temp_ini[3])/m[3]+time_start
time_cmin3=(temp_cmin[3]-temp_ini[3])/m[3]+time_start
time_cmax3=(temp_cmax[3]-temp_ini[3])/m[3]+time_start
